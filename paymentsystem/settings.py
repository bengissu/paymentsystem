...
SECRET_KEY = "django-insecure-&2l@z-vy$v!qvfaxam#7e$@)6c=c!_!#)z_jhg*gm#g&qe#^4z"
...
EXCHANGE_RATE = {
    ...
    "gbp_usd": Decimal(1.24),
    "gbp_eur": Decimal(1.13),
    "eur_gbp": Decimal(0.89),
    "eur_usd": Decimal(1.10),
    "usd_eur": Decimal(0.91),
    "usd_usd": Decimal(1),
    "eur_eur": Decimal(1),
    "gbp_gbp": Decimal(1),
}
